...
<head>
    ...
    <style>
        ...
        .card-hover:hover {
            ...
            box-shadow: 0 22px 40px -14px rgba(0,0,0,.15);
        }

        /* =========================
        SCALE DOWN ONLY (INTI)
        ========================= */

        /* Judul besar */
        .title-xl {
            font-size: 34px;   /* dari 52px */
            font-weight: 800;
        }

        /* Subjudul */
        .subtitle-xl {
            font-size: 16px;   /* dari 22px */
        }
        ...
        /* Link & button text yang pakai text-[20px] / text-[22px] */
        .text-\[20px\],
        .text-\[22px\] {
            font-size: 16px;
        }

        /* Text Tailwind besar → diturunkan secara global */
        .text-3xl { font-size: 1.5rem; } /* ~24px */
        .text-2xl { font-size: 1.25rem; } /* ~20px */
        .text-xl  { font-size: 1.125rem; } /* ~18px */
        .text-lg  { font-size: 1rem; }     /* ~16px */

        /* Padding besar diturunkan TANPA ubah class */
        .p-10 { padding: 1.75rem; } /* dari 2.5rem */
    </style>
</head>
